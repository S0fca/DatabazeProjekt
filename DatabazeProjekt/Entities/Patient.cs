namespace DatabazeProjekt.Entities
{
    internal class Patient
    {
        ...
        {
            return $"Name: {name} {surname}, Birth Date: {birth_dat:yyyy-MM-dd}, Birth Number: {birth_num}, Contact: {contact}, Height: {((height is null)?"-":height)}cm, Weight: {((weight is null)?"-":weight)}kg";
        }
